...
<body>
  <div class="sidebar">
      ...
      <div class="sidebar-menu">
          ...
          <li class="active">
              <a href="#"><i class="fas fa-users"></i><span>Migranti</span></a>
          </li>
          <li>
      ...
      ?>
        <main>
          ...
          <?php
              ...
              {
                $sql="SELECT * FROM migrant_table LIMIT $start_from, $num_per_page";
                $searchKey = "";
              }
        ...
        <table class="table">
                <tbody>
                    <tr>
                        <td data-label="ID" style="width:4%"><?= $rows['id_migranta'];?></td>
                        <td data-label="Ime"><?= $rows['ime']?></td>
                        <td data-label="Prezime"><?= $rows['prezime']?></td>
                        <td data-label="Uloga"><?= $rows['uloga']?></td>
                        <td data-label="Profilna"><img src="<?php echo $rows['profilna']?>" alt="slika" width="50px" height="50px" style="border-radius: 50%;"></td>
                        <td data-label="Email"><?= $rows['mesto_rodjenja']?></td>
                        <td data-label="Email"><?= $rows['email']?></td>
                        <td data-label="Izbriši" style="width:7%">
                        <form action="code.php" method="post">
                            <input type="hidden" type="submit" name="delete_competitor_id" placeholder="Izbriši" value="<?= $rows['id_migranta'];?>">
            ...
            <?php
                // PAGINATION
                $pr_query = "SELECT * FROM migrant_table";
