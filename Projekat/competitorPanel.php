        ...
        <main>
          ...
          <div class="update">
              ...
              <?php
                    ...
                    $sql1 = "SELECT * FROM migrant_table  WHERE `korisnicko_ime`='$_SESSION[CompetitorLoginId]'";
                ...
                <div>
                   <h2 style="color: #104e8b; font-weight: bold; padding-left: 30px;margin-bottom: 10px; font-size: 25px; min-height: 15px; width: 290px;">
                     <?php echo substr($rows['naslov'], 0, 100)." "?>
                   </h2>
                   ...
                   <p style="color: black; padding-left: 30px;margin-bottom: 10px; font-size: 15px; min-height: 15px; width: 290px;">
                     <?php echo substr($rows['sadrzaj'], 0, 50)." "?>
                   </p>
                   <div class="buttons">
                     <form action="code.php" method="post">
                       <input type="hidden" type="submit" name="id_turnira" value="<?= $rows['id_vesti'];?>">
                       <input type="hidden" type="submit" name="status" value="<?= $rows['naslov'];?>">
                       <!-- <input type="hidden" type="submit" name="statusTakmicara" value="<?= $row['sadrzaj'];?>"> -->
